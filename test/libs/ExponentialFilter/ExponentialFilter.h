...
#define EXPONENTIALFILTER_LIB_VERSION "0.1"

#include "Arduino.h"

// the filter will be used for integers only -> arduino, conversion to float will happen later
// but it should be implemented using templates... as seen at: 
class ExponentialFilter
{
public:
    ExponentialFilter(void);	//constructor?!
    explicit ExponentialFilter(const uint8_t);		// constructor
    ~ExponentialFilter();							// destructor

// TODO kill all the unneccessary stuff
